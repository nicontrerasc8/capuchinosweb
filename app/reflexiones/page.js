                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {parrafos.length > 0 && (
                        <div className="space-y-4 max-h-80 overflow-y-auto pr-2">
                            <h2 className="text-xl font-semibold text-gray-700">Párrafos de la Reflexión:</h2>
                            {parrafos.map((texto, index) => (
                                <div key={index} className="flex gap-4 items-start bg-gray-100 p-4 rounded-lg border border-gray-300">
                                    <textarea
                                        className="w-full bg-gray-100 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-700 rounded-lg transition-colors resize-none"
                                        value={texto}
